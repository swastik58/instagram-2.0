...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        // bucket in firebase storage,, reference in firebase storage
            ...
            <div className='flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
                ...
                >
                    <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left
                            overflow-hidden shadow-xl transform transition-all sm:my-0 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            
                        <div>
                            {selectedFile ? (
                                <img src={selectedFile} alt="selected picture" onClick={() => setSelectedFile(null)}
                            ...
                            <div className="mt-5 s,:mt-6">
                                <button type="button" onClick={uploadPost} disabled={!selectedFile}
